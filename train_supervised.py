...
from alphago.train import SupervisedTrainer

# from alphago.networks import SmallResidualNetwork
# from alphago.encoders import OnePlaneEncoder
from alphago.networks import AlphaGo
from alphago.encoders import AlphaGoEncoder
...
def main():
    ...
    encoder = AlphaGoEncoder(board_size=config.data.board_size)
    model = AlphaGo(board_size=config.data.board_size, in_channels=encoder.num_planes)
